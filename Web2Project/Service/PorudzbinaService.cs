...
namespace Web2Project.Service
{
    public class PorudzbinaService : IPorudzbinaService
    {
        ...
        public PorudzbinaService(IMapper mapper, CRUD_Context dbContext)
        {
        ...
        public async Task<PorudzbinaDto> AddPorudzbina(PorudzbinaDto newPorudzbinaDto)
        {
            ...
            catch (Exception e)
            {
                ...
                //obrisati porudzbinu
                PorudzbinaHelper.ReturnKolicinaArtikalaPorudzbine(newPorudzbinaDto.ArtikliPorudzbine, _dbContext);
                _dbContext.Porudzbine.Remove(newPorudzbina);
                await _dbContext.SaveChangesAsync();
                return null;
            }
        ...
        public async Task<PorudzbinaDto> UpdatePorudzbina(long id, PorudzbinaDto updatePorudzbinaDto)
        {
            ...
            PorudzbinaHelper.UpdatePorudzbinaFields(updatePorudzbina, updatePorudzbinaDto);
